...
public class Utils {
	...
	public static int getIdVeicoloByTipo(String tipo, int idTipo) throws Exception {
		
		String colonna = switch (tipo) {
			case "macchina" -> "id_macchina";
			case "moto" -> "id_moto";
			case "bici" -> "id_bici";
			default -> throw new IllegalArgumentException("Tipo non valido");
		};

		String query = "SELECT id_veicolo FROM " + tipo + " WHERE " + colonna + " = ?";
