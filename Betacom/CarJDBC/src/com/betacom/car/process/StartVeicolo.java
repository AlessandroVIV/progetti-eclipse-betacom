...
import com.betacom.car.utilities.GestioneMetodi;
...
//         System.out.println("Moto eliminata! Righe eliminate: " + deletedMoto);
			...
			GestioneMetodi gestione = new GestioneMetodi(daoV, daoM, daoMo, daoB);

			for (String riga : params) {
				
			    if (riga.startsWith("add:")) {
			    	gestione.gestisciAddGenerico(riga);
			    } else if (riga.startsWith("update:")) {
			    	gestione.gestisciUpdateGenerico(riga);
			    } else if (riga.startsWith("delete:")) {
			    	gestione.gestisciDeleteGenerico(riga);
			    } else if (riga.startsWith("list:")) {
			    	gestione.gestisciListGenerico(riga);
			    } else {
