...
public class VeicoloDAO {
	...
	public VeicoloDAO(DataSource dataSource, ColoreDAO coloreDAO, CategoriaDAO categoriaDAO,
			AlimentazioneDAO alimentazioneDAO, MarcaDAO marcaDAO, ModelloDAO modelloDAO, NumeroRuoteDAO numeroRuoteDAO,
			SospensioneDAO sospensioneDAO, MacchinaDAO macchinaDAO) {
	...
	@Transactional(rollbackFor = Exception.class)
	public void inserisciMacchina(int annoProduzione, int numeroRuote, String alimentazione, String categoria,
			String colore, String marca, String modello, int numeroPorte, String targa, int cilindrata) {
		...
		MapSqlParameterSource veicoloParams = new MapSqlParameterSource().addValue("anno", annoProduzione)
				.addValue("ruote", idNumeroRuote).addValue("alimentazione", idAlimentazione)
				.addValue("categoria", idCategoria).addValue("colore", idColore).addValue("marca", idMarca)
				.addValue("modello", idModello);
